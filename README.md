...
2. Install the JabFox add-on by downloading [the most recent version](https://github.com/JabRef/JabFox/releases). The JabRef icon should now appear in the Firefox toolbar. 
